...
void USBHS_RCC_Init(void)
{
    ...
    RCC_USBHSConfig(RCC_USBPLL_Div3);                    //                       // USBHS PLL 时钟源进入 PLL 前 3 分频
...
{
    USBHSD->ENDP_CONFIG = USBHS_UEP1_T_EN | USBHS_UEP1_R_EN | USBHS_UEP2_T_EN | USBHS_UEP3_T_EN | USBHS_UEP3_R_EN;
